...
export default function SystemPulseCard({ summary }) {
  return (
    <div className="bg-white dark:bg-[#111827] p-6 rounded-2xl border border-slate-200 dark:border-gray-800 space-y-5 transition-colors duration-200 shadow-sm dark:shadow-none">
      <div className="flex items-center justify-between border-b border-slate-200 dark:border-gray-800/80 pb-4">
        ...
        <span className="text-xs px-2.5 py-1 rounded-full bg-emerald-50 dark:bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-500/30 font-mono font-bold">
          98.7% CONFIDENCE
        </span>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3 text-xs font-mono">
        <div className="p-3 rounded-xl bg-slate-50 dark:bg-gray-900/60 border border-slate-200 dark:border-gray-800 space-y-1">
          <span className="text-slate-400 dark:text-gray-400 text-[10px] uppercase font-bold">ACTIVE RECOVERY RUNS</span>
        ...
        <div className="p-3 rounded-xl bg-slate-50 dark:bg-gray-900/60 border border-slate-200 dark:border-gray-800 space-y-1">
          <span className="text-slate-400 dark:text-gray-400 text-[10px] uppercase font-bold">FATIGUE GUARD STATUS</span>
          <div className="flex items-center space-x-2">
