...
import { BarChart3, TrendingUp, DollarSign, AlertOctagon, RefreshCw } from 'lucide-react';
...
export default function BatchAnalytics() {
  ...
  const { batchMetrics, eventTypePerformance } = data;
    ...
    <div className="space-y-8 pb-12 animate-fade-in transition-colors duration-200">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-slate-500 dark:text-gray-400 mt-1 font-mono">Empirical performance metrics across synthetic event cohort</p>
        </div>
      ...
      <div className="surface-level-2 p-6 rounded-2xl border border-slate-200 dark:border-gray-800 space-y-4">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-base font-bold text-slate-900 dark:text-white font-heading">Recovery Performance by Scenario</h3>
            <p className="text-xs text-slate-500 dark:text-gray-400 font-mono">At-Risk Revenue vs Recovered Revenue per Event Type</p>
          </div>
        ...
        <div className="h-64">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={eventTypeChartData}>
              ...
              <XAxis dataKey="name" stroke={isDark ? '#6B7280' : '#94A3B8'} fontSize={10} />
